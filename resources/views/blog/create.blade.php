...
@section('dashboard-content')
    ...
    <form name="createBlogPostForm" action="{{ URL::to('store-blog-post') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <textarea name="blogDetails" class="form-control" id="editor"></textarea>
        </div>
        <div class="form-group">
